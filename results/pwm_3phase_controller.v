module pwm_3phase_controller (VGND,
    VPWR,
    axi_arready,
    axi_arvalid,
    axi_awready,
 ...
 sky130_fd_sc_hd__fill_2 FILLER_0_0_113 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_8 FILLER_0_0_118 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_ef_sc_hd__decap_12 FILLER_0_22_233 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_fd_sc_hd__decap_4 FILLER_0_22_245 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_ef_sc_hd__decap_12 FILLER_0_23_3 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_fd_sc_hd__decap_6 FILLER_0_23_42 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__fill_1 FILLER_0_26_118 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_3 FILLER_0_26_145 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__fill_1 FILLER_0_28_56 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_6 FILLER_0_28_6 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_2_18 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_0_2_201 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_fd_sc_hd__decap_3 FILLER_0_39_3 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_6 FILLER_0_39_45 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__fill_1 FILLER_0_40_139 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_4 FILLER_0_40_14 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__fill_2 FILLER_0_40_26 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_8 FILLER_0_40_273 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_42_29 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_0_42_37 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_fd_sc_hd__fill_1 FILLER_0_44_112 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_3 FILLER_0_44_14 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_ef_sc_hd__decap_12 FILLER_0_45_3 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_fd_sc_hd__decap_8 FILLER_0_45_41 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_47_237 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_8 FILLER_0_47_244 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_3 FILLER_0_47_259 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_6 FILLER_0_47_266 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_47_76 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__fill_2 FILLER_0_47_85 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_99 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkbuf_2 _0502_ (.A(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0107_));
 sky130_fd_sc_hd__mux2_1 _0503_ (.A0(\aw_addr_reg[2] ),
    .A1(net12),
    .S(_0107_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0108_));
 sky130_fd_sc_hd__or3b_1 _0504_ (.A(net10),
    .B(net11),
    .C_N(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0109_));
 sky130_fd_sc_hd__o31a_1 _0505_ (.A1(_0107_),
    .A2(\aw_addr_reg[0] ),
    .A3(\aw_addr_reg[1] ),
    .B1(_0109_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0110_));
 sky130_fd_sc_hd__mux2_1 _0506_ (.A0(\aw_addr_reg[3] ),
    .A1(net13),
    .S(_0107_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0111_));
 sky130_fd_sc_hd__or3_1 _0507_ (.A(_0108_),
    .B(_0110_),
    .C(_0111_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0112_));
 sky130_fd_sc_hd__or4_1 _0508_ (.A(net18),
    .B(\aw_addr_reg[5] ),
    .C(\aw_addr_reg[6] ),
    .D(\aw_addr_reg[7] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0113_));
 sky130_fd_sc_hd__or4b_1 _0509_ (.A(net15),
    .B(net16),
    .C(net17),
    .D_N(net18),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0114_));
 sky130_fd_sc_hd__a21o_1 _0510_ (.A1(net36),
    .A2(net18),
    .B1(aw_active),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0115_));
 sky130_fd_sc_hd__nand2_2 _0511_ (.A(net33),
    .B(_0115_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0116_));
 sky130_fd_sc_hd__a21o_1 _0512_ (.A1(_0113_),
    .A2(_0114_),
    .B1(_0116_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0117_));
 sky130_fd_sc_hd__mux2_1 _0513_ (.A0(\aw_addr_reg[4] ),
    .A1(net14),
    .S(_0107_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0118_));
 sky130_fd_sc_hd__or2_1 _0514_ (.A(_0117_),
    .B(_0118_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0119_));
 sky130_fd_sc_hd__nor2_1 _0515_ (.A(_0112_),
    .B(_0119_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0120_));
 sky130_fd_sc_hd__and2_1 _0516_ (.A(net24),
    .B(_0120_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0121_));
 sky130_fd_sc_hd__clkbuf_1 _0517_ (.A(_0121_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0000_));
 sky130_fd_sc_hd__o21ba_1 _0518_ (.A1(net41),
    .A2(net130),
    .B1_N(fault_clear),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0001_));
 sky130_fd_sc_hd__or2b_1 _0519_ (.A(net41),
    .B_N(pwm_enable),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0122_));
 sky130_fd_sc_hd__clkbuf_4 _0520_ (.A(_0122_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0123_));
 sky130_fd_sc_hd__clkbuf_2 _0521_ (.A(_0123_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0124_));
 sky130_fd_sc_hd__clkbuf_2 _0522_ (.A(_0124_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0125_));
 sky130_fd_sc_hd__buf_2 _0523_ (.A(\carrier_cnt[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0126_));
 sky130_fd_sc_hd__inv_2 _0524_ (.A(_0126_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0127_));
 sky130_fd_sc_hd__xor2_1 _0525_ (.A(_0126_),
    .B(\duty_c[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0128_));
 sky130_fd_sc_hd__clkbuf_2 _0526_ (.A(\carrier_cnt[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0129_));
 sky130_fd_sc_hd__or3b_1 _0527_ (.A(\duty_c[10] ),
    .B(_0128_),
    .C_N(_0129_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0130_));
 sky130_fd_sc_hd__and2b_1 _0528_ (.A_N(net41),
    .B(pwm_enable),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0131_));
 sky130_fd_sc_hd__o211a_1 _0529_ (.A1(_0127_),
    .A2(\duty_c[11] ),
    .B1(_0130_),
    .C1(_0131_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0132_));
 sky130_fd_sc_hd__inv_2 _0530_ (.A(\carrier_cnt[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0133_));
 sky130_fd_sc_hd__inv_2 _0531_ (.A(\carrier_cnt[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0134_));
 sky130_fd_sc_hd__o22ai_2 _0532_ (.A1(_0133_),
    .A2(\duty_c[9] ),
    .B1(\duty_c[8] ),
    .B2(_0134_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0135_));
 sky130_fd_sc_hd__nand2_1 _0533_ (.A(_0133_),
    .B(\duty_c[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0136_));
 sky130_fd_sc_hd__xor2_1 _0534_ (.A(\carrier_cnt[10] ),
    .B(\duty_c[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0137_));
 sky130_fd_sc_hd__nor2_1 _0535_ (.A(_0128_),
    .B(_0137_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0138_));
 sky130_fd_sc_hd__buf_6 _0536_ (.A(\carrier_cnt[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0139_));
 sky130_fd_sc_hd__or2b_4 _0537_ (.A(\duty_c[6] ),
    .B_N(net120),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0140_));
 sky130_fd_sc_hd__buf_4 _0538_ (.A(\carrier_cnt[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0141_));
 sky130_fd_sc_hd__or2b_1 _0539_ (.A(\duty_c[7] ),
    .B_N(_0141_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0142_));
 sky130_fd_sc_hd__or2b_1 _0540_ (.A(\duty_c[7] ),
    .B_N(_0141_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0143_));
 sky130_fd_sc_hd__a21boi_1 _0541_ (.A1(_0140_),
    .A2(_0142_),
    .B1_N(_0143_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0144_));
 sky130_fd_sc_hd__inv_2 _0542_ (.A(\carrier_cnt[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0145_));
 sky130_fd_sc_hd__or2b_1 _0543_ (.A(\duty_c[5] ),
    .B_N(\carrier_cnt[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0146_));
 sky130_fd_sc_hd__o21ai_1 _0544_ (.A1(_0145_),
    .A2(\duty_c[4] ),
    .B1(_0146_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0147_));
 sky130_fd_sc_hd__or2b_1 _0545_ (.A(\carrier_cnt[5] ),
    .B_N(\duty_c[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0148_));
 sky130_fd_sc_hd__or2b_1 _0546_ (.A(\duty_c[6] ),
    .B_N(\carrier_cnt[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0149_));
 sky130_fd_sc_hd__and4_1 _0547_ (.A(_0140_),
    .B(_0142_),
    .C(_0149_),
    .D(_0143_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0150_));
 sky130_fd_sc_hd__and3_1 _0548_ (.A(_0147_),
    .B(_0148_),
    .C(_0150_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0151_));
 sky130_fd_sc_hd__clkbuf_2 _0549_ (.A(\carrier_cnt[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0152_));
 sky130_fd_sc_hd__inv_2 _0550_ (.A(\duty_c[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0153_));
 sky130_fd_sc_hd__and2b_1 _0551_ (.A_N(\duty_c[1] ),
    .B(\carrier_cnt[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0154_));
 sky130_fd_sc_hd__or2b_1 _0552_ (.A(\carrier_cnt[2] ),
    .B_N(\duty_c[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0155_));
 sky130_fd_sc_hd__or2b_1 _0553_ (.A(\carrier_cnt[1] ),
    .B_N(\duty_c[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0156_));
 sky130_fd_sc_hd__o311a_1 _0554_ (.A1(_0152_),
    .A2(_0153_),
    .A3(_0154_),
    .B1(_0155_),
    .C1(_0156_),
    ...
    .VPWR(VPWR),
    .X(_0157_));
 sky130_fd_sc_hd__inv_2 _0555_ (.A(\carrier_cnt[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0158_));
 sky130_fd_sc_hd__inv_2 _0556_ (.A(\duty_c[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0159_));
 sky130_fd_sc_hd__a2bb2o_1 _0557_ (.A1_N(\duty_c[2] ),
    .A2_N(_0158_),
    .B1(\carrier_cnt[3] ),
    .B2(_0159_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0160_));
 sky130_fd_sc_hd__o2bb2a_1 _0558_ (.A1_N(_0145_),
    .A2_N(\duty_c[4] ),
    .B1(_0159_),
    .B2(\carrier_cnt[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0161_));
 sky130_fd_sc_hd__o211a_1 _0559_ (.A1(_0145_),
    .A2(\duty_c[4] ),
    .B1(_0146_),
    .C1(_0148_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0162_));
 sky130_fd_sc_hd__o2111a_1 _0560_ (.A1(_0157_),
    .A2(_0160_),
    .B1(_0161_),
    .C1(net124),
    .D1(_0162_),
    ...
    .VPWR(VPWR),
    .X(_0163_));
 sky130_fd_sc_hd__nand2_1 _0561_ (.A(_0134_),
    .B(\duty_c[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0164_));
 sky130_fd_sc_hd__and3b_1 _0562_ (.A_N(_0135_),
    .B(_0164_),
    .C(_0136_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0165_));
 sky130_fd_sc_hd__o311a_4 _0563_ (.A1(_0144_),
    .A2(_0151_),
    .A3(_0163_),
    .B1(_0165_),
    .C1(_0138_),
    ...
    .VPWR(VPWR),
    .X(_0166_));
 sky130_fd_sc_hd__a31oi_4 _0564_ (.A1(_0135_),
    .A2(_0136_),
    .A3(_0138_),
    .B1(_0166_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0167_));
 sky130_fd_sc_hd__a22o_1 _0565_ (.A1(net141),
    .A2(_0125_),
    .B1(_0132_),
    .B2(_0167_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0002_));
 sky130_fd_sc_hd__inv_2 _0566_ (.A(net153),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0168_));
 sky130_fd_sc_hd__o21ai_1 _0567_ (.A1(_0168_),
    .A2(_0107_),
    .B1(_0116_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0003_));
 sky130_fd_sc_hd__mux2_1 _0568_ (.A0(_0116_),
    .A1(net19),
    .S(net37),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0169_));
 sky130_fd_sc_hd__inv_2 _0569_ (.A(_0169_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _0570_ (.A(net20),
    ...
    .VPWR(VPWR),
    .Y(_0170_));
 sky130_fd_sc_hd__mux2_1 _0571_ (.A0(net9),
    .A1(_0170_),
    .S(net40),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0171_));
 sky130_fd_sc_hd__clkbuf_1 _0572_ (.A(_0171_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0005_));
 sky130_fd_sc_hd__mux2_1 _0573_ (.A0(net161),
    .A1(pwm_enable),
    .S(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0172_));
 sky130_fd_sc_hd__clkbuf_1 _0574_ (.A(_0172_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0006_));
 sky130_fd_sc_hd__or4b_1 _0575_ (.A(net6),
    .B(net8),
    .C(net7),
    .D_N(net5),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0173_));
 sky130_fd_sc_hd__or4b_1 _0576_ (.A(net2),
    .B(net1),
    .C(net4),
    .D_N(net3),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0174_));
 sky130_fd_sc_hd__nor2_1 _0577_ (.A(_0173_),
    .B(_0174_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0175_));
 sky130_fd_sc_hd__and2b_1 _0578_ (.A_N(net9),
    .B(net39),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0176_));
 sky130_fd_sc_hd__a31o_1 _0579_ (.A1(net155),
    .A2(net9),
    .A3(_0175_),
    .B1(_0176_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0007_));
 sky130_fd_sc_hd__mux2_1 _0580_ (.A0(pwm_enable),
    .A1(net21),
    .S(_0120_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0177_));
 sky130_fd_sc_hd__clkbuf_1 _0581_ (.A(_0177_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0008_));
 sky130_fd_sc_hd__or4b_1 _0582_ (.A(_0110_),
    .B(_0111_),
    .C(_0119_),
    .D_N(_0108_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0178_));
 sky130_fd_sc_hd__buf_2 _0583_ (.A(_0178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0179_));
 sky130_fd_sc_hd__mux2_1 _0584_ (.A0(net21),
    .A1(net159),
    .S(_0179_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0180_));
 sky130_fd_sc_hd__clkbuf_1 _0585_ (.A(_0180_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__mux2_1 _0586_ (.A0(net24),
    ...
    .VPWR(VPWR),
    .X(_0181_));
 sky130_fd_sc_hd__clkbuf_1 _0587_ (.A(_0181_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0010_));
 sky130_fd_sc_hd__mux2_1 _0588_ (.A0(net25),
    .A1(\duty_a[2] ),
    .S(_0179_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0182_));
 sky130_fd_sc_hd__clkbuf_1 _0589_ (.A(_0182_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0011_));
 sky130_fd_sc_hd__mux2_1 _0590_ (.A0(net26),
    .A1(\duty_a[3] ),
    .S(_0179_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0183_));
 sky130_fd_sc_hd__clkbuf_1 _0591_ (.A(_0183_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0012_));
 sky130_fd_sc_hd__mux2_1 _0592_ (.A0(net27),
    .A1(\duty_a[4] ),
    .S(_0179_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0184_));
 sky130_fd_sc_hd__clkbuf_1 _0593_ (.A(_0184_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0013_));
 sky130_fd_sc_hd__mux2_1 _0594_ (.A0(net28),
    .A1(\duty_a[5] ),
    .S(_0179_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0185_));
 sky130_fd_sc_hd__clkbuf_1 _0595_ (.A(_0185_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0014_));
 sky130_fd_sc_hd__clkbuf_4 _0596_ (.A(_0178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0186_));
 sky130_fd_sc_hd__mux2_1 _0597_ (.A0(net29),
    .A1(\duty_a[6] ),
    .S(_0186_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0187_));
 sky130_fd_sc_hd__clkbuf_1 _0598_ (.A(_0187_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0015_));
 sky130_fd_sc_hd__mux2_1 _0599_ (.A0(net30),
    .A1(\duty_a[7] ),
    .S(_0186_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0188_));
 sky130_fd_sc_hd__clkbuf_1 _0600_ (.A(_0188_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0016_));
 sky130_fd_sc_hd__mux2_1 _0601_ (.A0(net31),
    .A1(\duty_a[8] ),
    .S(_0186_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0189_));
 sky130_fd_sc_hd__clkbuf_1 _0602_ (.A(_0189_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0017_));
 sky130_fd_sc_hd__mux2_1 _0603_ (.A0(net32),
    .A1(\duty_a[9] ),
    .S(_0186_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0190_));
 sky130_fd_sc_hd__clkbuf_1 _0604_ (.A(_0190_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0018_));
 sky130_fd_sc_hd__mux2_1 _0605_ (.A0(net22),
    .A1(\duty_a[10] ),
    .S(_0186_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0191_));
 sky130_fd_sc_hd__clkbuf_1 _0606_ (.A(_0191_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0019_));
 sky130_fd_sc_hd__mux2_1 _0607_ (.A0(net23),
    .A1(\duty_a[11] ),
    .S(_0186_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0192_));
 sky130_fd_sc_hd__clkbuf_1 _0608_ (.A(_0192_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0020_));
 sky130_fd_sc_hd__nor2_1 _0609_ (.A(_0117_),
    .B(_0118_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0193_));
 sky130_fd_sc_hd__and4bb_1 _0610_ (.A_N(_0108_),
    .B_N(_0110_),
    .C(_0111_),
    .D(_0193_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0194_));
 sky130_fd_sc_hd__buf_2 _0611_ (.A(_0194_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0195_));
 sky130_fd_sc_hd__mux2_1 _0612_ (.A0(net160),
    .A1(net21),
    .S(_0195_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0196_));
 sky130_fd_sc_hd__clkbuf_1 _0613_ (.A(_0196_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0021_));
 sky130_fd_sc_hd__mux2_1 _0614_ (.A0(net165),
    .A1(net24),
    .S(_0195_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0197_));
 sky130_fd_sc_hd__clkbuf_1 _0615_ (.A(_0197_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0022_));
 sky130_fd_sc_hd__mux2_1 _0616_ (.A0(\duty_b[2] ),
    .A1(net25),
    .S(_0195_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0198_));
 sky130_fd_sc_hd__clkbuf_1 _0617_ (.A(_0198_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0023_));
 sky130_fd_sc_hd__mux2_1 _0618_ (.A0(\duty_b[3] ),
    .A1(net26),
    .S(_0195_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _0619_ (.A(_0199_),
    ...
    .VPWR(VPWR),
    .X(_0024_));
 sky130_fd_sc_hd__mux2_1 _0620_ (.A0(\duty_b[4] ),
    .A1(net27),
    .S(_0195_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0200_));
 sky130_fd_sc_hd__clkbuf_1 _0621_ (.A(_0200_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0025_));
 sky130_fd_sc_hd__mux2_1 _0622_ (.A0(net164),
    .A1(net28),
    .S(_0195_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0201_));
 sky130_fd_sc_hd__clkbuf_1 _0623_ (.A(_0201_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0026_));
 sky130_fd_sc_hd__clkbuf_4 _0624_ (.A(_0194_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0202_));
 sky130_fd_sc_hd__mux2_1 _0625_ (.A0(\duty_b[6] ),
    .A1(net29),
    .S(_0202_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0203_));
 sky130_fd_sc_hd__clkbuf_1 _0626_ (.A(_0203_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0027_));
 sky130_fd_sc_hd__mux2_1 _0627_ (.A0(\duty_b[7] ),
    .A1(net30),
    .S(_0202_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0204_));
 sky130_fd_sc_hd__clkbuf_1 _0628_ (.A(_0204_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0028_));
 sky130_fd_sc_hd__mux2_1 _0629_ (.A0(\duty_b[8] ),
    .A1(net31),
    .S(_0202_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0205_));
 sky130_fd_sc_hd__clkbuf_1 _0630_ (.A(_0205_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0029_));
 sky130_fd_sc_hd__mux2_1 _0631_ (.A0(\duty_b[9] ),
    .A1(net32),
    .S(_0202_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0206_));
 sky130_fd_sc_hd__clkbuf_1 _0632_ (.A(_0206_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0030_));
 sky130_fd_sc_hd__mux2_1 _0633_ (.A0(\duty_b[10] ),
    .A1(net22),
    .S(_0202_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0207_));
 sky130_fd_sc_hd__clkbuf_1 _0634_ (.A(_0207_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0031_));
 sky130_fd_sc_hd__mux2_1 _0635_ (.A0(net117),
    .A1(net23),
    .S(_0202_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0208_));
 sky130_fd_sc_hd__clkbuf_1 _0636_ (.A(_0208_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0032_));
 sky130_fd_sc_hd__and4b_1 _0637_ (.A_N(_0110_),
    .B(_0111_),
    .C(_0193_),
    .D(_0108_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0209_));
 sky130_fd_sc_hd__buf_2 _0638_ (.A(_0209_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0210_));
 sky130_fd_sc_hd__mux2_1 _0639_ (.A0(\duty_c[0] ),
    .A1(net21),
    .S(_0210_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0211_));
 sky130_fd_sc_hd__clkbuf_1 _0640_ (.A(_0211_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0033_));
 sky130_fd_sc_hd__mux2_1 _0641_ (.A0(net162),
    .A1(net24),
    .S(_0210_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0212_));
 sky130_fd_sc_hd__clkbuf_1 _0642_ (.A(_0212_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0034_));
 sky130_fd_sc_hd__mux2_1 _0643_ (.A0(\duty_c[2] ),
    .A1(net25),
    .S(_0210_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0213_));
 sky130_fd_sc_hd__clkbuf_1 _0644_ (.A(_0213_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0035_));
 sky130_fd_sc_hd__mux2_1 _0645_ (.A0(\duty_c[3] ),
    .A1(net26),
    .S(_0210_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0214_));
 sky130_fd_sc_hd__clkbuf_1 _0646_ (.A(_0214_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0036_));
 sky130_fd_sc_hd__mux2_1 _0647_ (.A0(\duty_c[4] ),
    .A1(net27),
    .S(_0210_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0215_));
 sky130_fd_sc_hd__clkbuf_1 _0648_ (.A(_0215_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0037_));
 sky130_fd_sc_hd__mux2_1 _0649_ (.A0(net166),
    .A1(net28),
    .S(_0210_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0216_));
 sky130_fd_sc_hd__clkbuf_1 _0650_ (.A(_0216_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0038_));
 sky130_fd_sc_hd__clkbuf_4 _0651_ (.A(_0209_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0217_));
 sky130_fd_sc_hd__mux2_1 _0652_ (.A0(\duty_c[6] ),
    .A1(net29),
    .S(_0217_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0218_));
 sky130_fd_sc_hd__clkbuf_1 _0653_ (.A(_0218_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0039_));
 sky130_fd_sc_hd__mux2_1 _0654_ (.A0(\duty_c[7] ),
    .A1(net30),
    .S(_0217_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0219_));
 sky130_fd_sc_hd__clkbuf_1 _0655_ (.A(_0219_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0040_));
 sky130_fd_sc_hd__mux2_1 _0656_ (.A0(\duty_c[8] ),
    .A1(net31),
    .S(_0217_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0220_));
 sky130_fd_sc_hd__clkbuf_1 _0657_ (.A(_0220_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0041_));
 sky130_fd_sc_hd__mux2_1 _0658_ (.A0(\duty_c[9] ),
    .A1(net32),
    .S(_0217_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0221_));
 sky130_fd_sc_hd__clkbuf_1 _0659_ (.A(_0221_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0042_));
 sky130_fd_sc_hd__mux2_1 _0660_ (.A0(\duty_c[10] ),
    .A1(net22),
    .S(_0217_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _0661_ (.A(_0222_),
    ...
    .VPWR(VPWR),
    .X(_0043_));
 sky130_fd_sc_hd__mux2_1 _0662_ (.A0(\duty_c[11] ),
    .A1(net23),
    .S(_0217_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0223_));
 sky130_fd_sc_hd__clkbuf_1 _0663_ (.A(_0223_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0044_));
 sky130_fd_sc_hd__nor3b_2 _0664_ (.A(_0112_),
    .B(_0117_),
    .C_N(_0118_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0224_));
 sky130_fd_sc_hd__buf_2 _0665_ (.A(_0224_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0225_));
 sky130_fd_sc_hd__mux2_1 _0666_ (.A0(\dt_a.dt_cfg[0] ),
    .A1(net21),
    .S(_0225_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0226_));
 sky130_fd_sc_hd__clkbuf_1 _0667_ (.A(_0226_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0045_));
 sky130_fd_sc_hd__mux2_1 _0668_ (.A0(\dt_a.dt_cfg[1] ),
    .A1(net24),
    .S(_0225_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0227_));
 sky130_fd_sc_hd__clkbuf_1 _0669_ (.A(_0227_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0046_));
 sky130_fd_sc_hd__mux2_1 _0670_ (.A0(\dt_a.dt_cfg[2] ),
    .A1(net25),
    .S(_0225_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0228_));
 sky130_fd_sc_hd__clkbuf_1 _0671_ (.A(_0228_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0047_));
 sky130_fd_sc_hd__mux2_1 _0672_ (.A0(\dt_a.dt_cfg[3] ),
    .A1(net26),
    .S(_0225_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0229_));
 sky130_fd_sc_hd__clkbuf_1 _0673_ (.A(_0229_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0048_));
 sky130_fd_sc_hd__mux2_1 _0674_ (.A0(\dt_a.dt_cfg[4] ),
    .A1(net27),
    .S(_0225_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0230_));
 sky130_fd_sc_hd__clkbuf_1 _0675_ (.A(_0230_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0049_));
 sky130_fd_sc_hd__mux2_1 _0676_ (.A0(\dt_a.dt_cfg[5] ),
    .A1(net28),
    .S(_0225_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0231_));
 sky130_fd_sc_hd__clkbuf_1 _0677_ (.A(_0231_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0050_));
 sky130_fd_sc_hd__mux2_1 _0678_ (.A0(\dt_a.dt_cfg[6] ),
    .A1(net29),
    .S(_0224_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0232_));
 sky130_fd_sc_hd__clkbuf_1 _0679_ (.A(_0232_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0051_));
 sky130_fd_sc_hd__mux2_1 _0680_ (.A0(net170),
    .A1(net30),
    .S(_0224_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0233_));
 sky130_fd_sc_hd__clkbuf_1 _0681_ (.A(_0233_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0052_));
 sky130_fd_sc_hd__and3_1 _0682_ (.A(net36),
    .B(_0107_),
    .C(net55),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0234_));
 sky130_fd_sc_hd__buf_2 _0683_ (.A(_0234_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0235_));
 sky130_fd_sc_hd__mux2_1 _0684_ (.A0(net150),
    .A1(net10),
    .S(_0235_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0236_));
 sky130_fd_sc_hd__clkbuf_1 _0685_ (.A(_0236_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0053_));
 sky130_fd_sc_hd__mux2_1 _0686_ (.A0(net149),
    .A1(net11),
    .S(_0235_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0237_));
 sky130_fd_sc_hd__clkbuf_1 _0687_ (.A(_0237_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0054_));
 sky130_fd_sc_hd__mux2_1 _0688_ (.A0(net139),
    .A1(net12),
    .S(_0235_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0238_));
 sky130_fd_sc_hd__clkbuf_1 _0689_ (.A(_0238_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0055_));
 sky130_fd_sc_hd__mux2_1 _0690_ (.A0(net140),
    .A1(net13),
    .S(_0235_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0239_));
 sky130_fd_sc_hd__clkbuf_1 _0691_ (.A(_0239_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0056_));
 sky130_fd_sc_hd__mux2_1 _0692_ (.A0(net144),
    .A1(net14),
    .S(_0235_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0240_));
 sky130_fd_sc_hd__clkbuf_1 _0693_ (.A(_0240_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0057_));
 sky130_fd_sc_hd__mux2_1 _0694_ (.A0(net148),
    .A1(net15),
    .S(_0235_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0241_));
 sky130_fd_sc_hd__clkbuf_1 _0695_ (.A(_0241_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0058_));
 sky130_fd_sc_hd__mux2_1 _0696_ (.A0(net137),
    .A1(net16),
    .S(_0234_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0242_));
 sky130_fd_sc_hd__clkbuf_1 _0697_ (.A(_0242_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0059_));
 sky130_fd_sc_hd__mux2_1 _0698_ (.A0(net143),
    .A1(net17),
    .S(_0234_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0243_));
 sky130_fd_sc_hd__clkbuf_1 _0699_ (.A(_0243_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0060_));
 sky130_fd_sc_hd__and2b_1 _0700_ (.A_N(net33),
    .B(_0115_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0244_));
 sky130_fd_sc_hd__clkbuf_1 _0701_ (.A(_0244_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0061_));
 sky130_fd_sc_hd__buf_4 _0702_ (.A(\carrier_cnt[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0245_));
 sky130_fd_sc_hd__xnor2_2 _0703_ (.A(carrier_up),
    .B(_0245_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0246_));
 sky130_fd_sc_hd__or2_1 _0704_ (.A(\carrier_cnt[9] ),
    .B(\carrier_cnt[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0247_));
 sky130_fd_sc_hd__or4_1 _0705_ (.A(\carrier_cnt[3] ),
    .B(\carrier_cnt[2] ),
    .C(_0122_),
    .D(_0247_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0248_));
 sky130_fd_sc_hd__clkbuf_2 _0706_ (.A(\carrier_cnt[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0249_));
 sky130_fd_sc_hd__clkbuf_2 _0707_ (.A(\carrier_cnt[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0250_));
 sky130_fd_sc_hd__or4_1 _0708_ (.A(_0249_),
    .B(_0250_),
    .C(_0141_),
    .D(net121),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0251_));
 sky130_fd_sc_hd__or4_1 _0709_ (.A(_0245_),
    .B(_0152_),
    .C(_0126_),
    .D(_0129_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0252_));
 sky130_fd_sc_hd__or3_1 _0710_ (.A(_0248_),
    .B(_0251_),
    .C(_0252_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0253_));
 sky130_fd_sc_hd__inv_2 _0711_ (.A(_0253_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0254_));
 sky130_fd_sc_hd__a21o_2 _0712_ (.A1(_0246_),
    .A2(_0254_),
    .B1(_0123_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0255_));
 sky130_fd_sc_hd__nor2_1 _0713_ (.A(_0152_),
    .B(_0255_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0062_));
 sky130_fd_sc_hd__a21oi_1 _0714_ (.A1(_0246_),
    .A2(_0254_),
    .B1(_0123_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0256_));
 sky130_fd_sc_hd__clkbuf_2 _0715_ (.A(_0256_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0257_));
 sky130_fd_sc_hd__or2_1 _0716_ (.A(_0152_),
    .B(_0246_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0258_));
 sky130_fd_sc_hd__nand2_1 _0717_ (.A(_0152_),
    .B(_0246_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0259_));
 sky130_fd_sc_hd__and3_1 _0718_ (.A(_0257_),
    .B(_0258_),
    .C(_0259_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0260_));
 sky130_fd_sc_hd__clkbuf_1 _0719_ (.A(_0260_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0063_));
 sky130_fd_sc_hd__buf_2 _0720_ (.A(carrier_up),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0261_));
 sky130_fd_sc_hd__inv_2 _0721_ (.A(_0261_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0262_));
 sky130_fd_sc_hd__nand2_1 _0722_ (.A(_0262_),
    .B(\carrier_cnt[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0263_));
 sky130_fd_sc_hd__clkbuf_2 _0723_ (.A(_0261_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0264_));
 sky130_fd_sc_hd__nand2_1 _0724_ (.A(_0264_),
    .B(_0158_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0265_));
 sky130_fd_sc_hd__and2b_1 _0725_ (.A_N(_0261_),
    .B(_0245_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0266_));
 sky130_fd_sc_hd__a21o_1 _0726_ (.A1(_0152_),
    .A2(_0246_),
    .B1(_0266_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0267_));
 sky130_fd_sc_hd__nand3_1 _0727_ (.A(_0263_),
    .B(_0265_),
    .C(_0267_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0268_));
 sky130_fd_sc_hd__a21o_1 _0728_ (.A1(_0263_),
    .A2(_0265_),
    .B1(_0267_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0269_));
 sky130_fd_sc_hd__and3_1 _0729_ (.A(_0257_),
    .B(_0268_),
    .C(_0269_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0270_));
 sky130_fd_sc_hd__clkbuf_1 _0730_ (.A(_0270_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0064_));
 sky130_fd_sc_hd__buf_2 _0731_ (.A(_0264_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _0732_ (.A(_0271_),
    ...
    .VPWR(VPWR),
    .Y(_0272_));
 sky130_fd_sc_hd__a21oi_1 _0733_ (.A1(_0263_),
    .A2(_0268_),
    .B1(_0272_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0273_));
 sky130_fd_sc_hd__and3_1 _0734_ (.A(_0263_),
    .B(_0268_),
    .C(_0272_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0274_));
 sky130_fd_sc_hd__o21a_1 _0735_ (.A1(_0273_),
    .A2(_0274_),
    .B1(_0257_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0065_));
 sky130_fd_sc_hd__xnor2_1 _0736_ (.A(_0264_),
    .B(_0250_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0275_));
 sky130_fd_sc_hd__inv_2 _0737_ (.A(\carrier_cnt[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0276_));
 sky130_fd_sc_hd__nand2_1 _0738_ (.A(_0264_),
    .B(_0276_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0277_));
 sky130_fd_sc_hd__a21oi_1 _0739_ (.A1(_0276_),
    .A2(_0158_),
    .B1(_0264_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0278_));
 sky130_fd_sc_hd__a41o_1 _0740_ (.A1(_0263_),
    .A2(_0265_),
    .A3(_0267_),
    .A4(_0277_),
    .B1(_0278_),
    ...
    .VPWR(VPWR),
    .X(_0279_));
 sky130_fd_sc_hd__or2_1 _0741_ (.A(_0275_),
    .B(_0279_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0280_));
 sky130_fd_sc_hd__nand2_1 _0742_ (.A(_0275_),
    .B(_0279_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0281_));
 sky130_fd_sc_hd__and3_1 _0743_ (.A(_0257_),
    .B(_0280_),
    .C(_0281_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0282_));
 sky130_fd_sc_hd__clkbuf_1 _0744_ (.A(_0282_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0066_));
 sky130_fd_sc_hd__o21ai_1 _0745_ (.A1(_0271_),
    .A2(_0145_),
    .B1(_0281_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0283_));
 sky130_fd_sc_hd__xor2_1 _0746_ (.A(_0261_),
    .B(_0249_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0284_));
 sky130_fd_sc_hd__xor2_1 _0747_ (.A(_0283_),
    .B(_0284_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0285_));
 sky130_fd_sc_hd__nor2_1 _0748_ (.A(_0255_),
    .B(_0285_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0067_));
 sky130_fd_sc_hd__xnor2_1 _0749_ (.A(_0261_),
    .B(net122),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0286_));
 sky130_fd_sc_hd__nor2_1 _0750_ (.A(_0281_),
    .B(_0284_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0287_));
 sky130_fd_sc_hd__clkbuf_2 _0751_ (.A(_0262_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0288_));
 sky130_fd_sc_hd__o21a_1 _0752_ (.A1(_0249_),
    .A2(_0250_),
    .B1(_0288_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0289_));
 sky130_fd_sc_hd__o21ai_1 _0753_ (.A1(_0287_),
    .A2(_0289_),
    .B1(_0286_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0290_));
 sky130_fd_sc_hd__o311a_1 _0754_ (.A1(_0286_),
    .A2(_0287_),
    .A3(_0289_),
    .B1(_0290_),
    .C1(_0257_),
    ...
    .VPWR(VPWR),
    .X(_0068_));
 sky130_fd_sc_hd__a21bo_1 _0755_ (.A1(_0288_),
    .A2(net123),
    .B1_N(_0290_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0291_));
 sky130_fd_sc_hd__xnor2_1 _0756_ (.A(_0261_),
    .B(_0141_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0292_));
 sky130_fd_sc_hd__xnor2_1 _0757_ (.A(_0291_),
    .B(_0292_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _0758_ (.A(_0255_),
    ...
    .VPWR(VPWR),
    .Y(_0069_));
 sky130_fd_sc_hd__xor2_1 _0759_ (.A(_0264_),
    .B(\carrier_cnt[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0294_));
 sky130_fd_sc_hd__and4b_1 _0760_ (.A_N(_0284_),
    .B(_0286_),
    .C(_0292_),
    .D(_0275_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0295_));
 sky130_fd_sc_hd__a22oi_2 _0761_ (.A1(_0262_),
    .A2(_0251_),
    .B1(_0279_),
    .B2(_0295_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0296_));
 sky130_fd_sc_hd__nor2_1 _0762_ (.A(_0294_),
    .B(_0296_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0297_));
 sky130_fd_sc_hd__or2_1 _0763_ (.A(_0255_),
    .B(_0297_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0298_));
 sky130_fd_sc_hd__a21oi_1 _0764_ (.A1(_0294_),
    .A2(_0296_),
    .B1(_0298_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0070_));
 sky130_fd_sc_hd__a21o_1 _0765_ (.A1(_0288_),
    .A2(\carrier_cnt[8] ),
    .B1(_0297_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0299_));
 sky130_fd_sc_hd__xnor2_1 _0766_ (.A(_0271_),
    .B(\carrier_cnt[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0300_));
 sky130_fd_sc_hd__xnor2_1 _0767_ (.A(_0299_),
    .B(_0300_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0301_));
 sky130_fd_sc_hd__nor2_1 _0768_ (.A(_0255_),
    .B(_0301_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0071_));
 sky130_fd_sc_hd__a22o_1 _0769_ (.A1(_0288_),
    .A2(_0247_),
    .B1(_0297_),
    .B2(_0300_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0302_));
 sky130_fd_sc_hd__xnor2_1 _0770_ (.A(_0271_),
    .B(_0129_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0303_));
 sky130_fd_sc_hd__nor2_1 _0771_ (.A(_0302_),
    .B(_0303_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0304_));
 sky130_fd_sc_hd__nand2_1 _0772_ (.A(_0302_),
    .B(_0303_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0305_));
 sky130_fd_sc_hd__and3b_1 _0773_ (.A_N(_0304_),
    .B(_0305_),
    .C(_0256_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0306_));
 sky130_fd_sc_hd__clkbuf_1 _0774_ (.A(_0306_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0072_));
 sky130_fd_sc_hd__nand2_1 _0775_ (.A(_0288_),
    .B(_0129_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0307_));
 sky130_fd_sc_hd__nand2_1 _0776_ (.A(_0271_),
    .B(_0126_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0308_));
 sky130_fd_sc_hd__or2_1 _0777_ (.A(_0271_),
    .B(_0126_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0309_));
 sky130_fd_sc_hd__a22o_1 _0778_ (.A1(_0307_),
    .A2(_0305_),
    .B1(_0308_),
    .B2(_0309_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0310_));
 sky130_fd_sc_hd__nand4_1 _0779_ (.A(_0307_),
    .B(_0305_),
    .C(_0308_),
    .D(_0309_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0311_));
 sky130_fd_sc_hd__and3_1 _0780_ (.A(_0257_),
    .B(_0310_),
    .C(_0311_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0312_));
 sky130_fd_sc_hd__clkbuf_1 _0781_ (.A(_0312_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0073_));
 sky130_fd_sc_hd__nand2_1 _0782_ (.A(_0288_),
    .B(_0253_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0074_));
 sky130_fd_sc_hd__o22a_1 _0783_ (.A1(_0133_),
    .A2(\duty_a[9] ),
    .B1(\duty_a[8] ),
    .B2(_0134_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0313_));
 sky130_fd_sc_hd__and2_1 _0784_ (.A(_0133_),
    .B(\duty_a[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0314_));
 sky130_fd_sc_hd__xor2_1 _0785_ (.A(_0126_),
    .B(\duty_a[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0315_));
 sky130_fd_sc_hd__xor2_1 _0786_ (.A(\carrier_cnt[10] ),
    .B(\duty_a[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0316_));
 sky130_fd_sc_hd__or2_4 _0787_ (.A(_0315_),
    .B(_0316_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0317_));
 sky130_fd_sc_hd__and2b_1 _0788_ (.A_N(\carrier_cnt[6] ),
    .B(\duty_a[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0318_));
 sky130_fd_sc_hd__and2b_1 _0789_ (.A_N(\carrier_cnt[7] ),
    .B(\duty_a[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0319_));
 sky130_fd_sc_hd__and2b_1 _0790_ (.A_N(_0141_),
    .B(net115),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0320_));
 sky130_fd_sc_hd__o21bai_1 _0791_ (.A1(_0318_),
    .A2(_0319_),
    .B1_N(_0320_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0321_));
 sky130_fd_sc_hd__inv_2 _0792_ (.A(\duty_a[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0322_));
 sky130_fd_sc_hd__and2b_1 _0793_ (.A_N(\duty_a[5] ),
    .B(_0249_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0323_));
 sky130_fd_sc_hd__a21oi_1 _0794_ (.A1(_0250_),
    .A2(_0322_),
    .B1(_0323_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0324_));
 sky130_fd_sc_hd__and2b_1 _0795_ (.A_N(_0249_),
    .B(\duty_a[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0325_));
 sky130_fd_sc_hd__and2b_1 _0796_ (.A_N(_0139_),
    .B(\duty_a[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0326_));
 sky130_fd_sc_hd__or4_4 _0797_ (.A(_0318_),
    .B(_0319_),
    .C(_0326_),
    .D(_0320_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0327_));
 sky130_fd_sc_hd__or3_4 _0798_ (.A(_0324_),
    .B(_0325_),
    .C(_0327_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0328_));
 sky130_fd_sc_hd__inv_2 _0799_ (.A(\carrier_cnt[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0329_));
 sky130_fd_sc_hd__or2b_1 _0800_ (.A(\duty_a[1] ),
    .B_N(_0245_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0330_));
 sky130_fd_sc_hd__and2b_1 _0801_ (.A_N(\carrier_cnt[2] ),
    .B(\duty_a[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0331_));
 sky130_fd_sc_hd__and2b_1 _0802_ (.A_N(_0245_),
    .B(\duty_a[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0332_));
 sky130_fd_sc_hd__a311o_1 _0803_ (.A1(_0329_),
    .A2(\duty_a[0] ),
    .A3(_0330_),
    .B1(_0331_),
    .C1(_0332_),
    ...
    .VPWR(VPWR),
    .X(_0333_));
 sky130_fd_sc_hd__o22a_1 _0804_ (.A1(_0276_),
    .A2(\duty_a[3] ),
    .B1(\duty_a[2] ),
    .B2(_0158_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0334_));
 sky130_fd_sc_hd__a22o_1 _0805_ (.A1(_0145_),
    .A2(\duty_a[4] ),
    .B1(\duty_a[3] ),
    .B2(_0276_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0335_));
 sky130_fd_sc_hd__a211o_1 _0806_ (.A1(_0250_),
    .A2(_0322_),
    .B1(_0323_),
    .C1(_0325_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0336_));
 sky130_fd_sc_hd__a2111o_1 _0807_ (.A1(_0333_),
    .A2(_0334_),
    .B1(_0335_),
    .C1(_0327_),
    .D1(_0336_),
    ...
    .VPWR(VPWR),
    .X(_0337_));
 sky130_fd_sc_hd__and2_1 _0808_ (.A(_0134_),
    .B(\duty_a[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0338_));
 sky130_fd_sc_hd__or4b_4 _0809_ (.A(_0338_),
    .B(_0314_),
    .C(_0317_),
    .D_N(_0313_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0339_));
 sky130_fd_sc_hd__a31o_1 _0810_ (.A1(_0321_),
    .A2(_0328_),
    .A3(_0337_),
    .B1(_0339_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0340_));
 sky130_fd_sc_hd__o31ai_4 _0811_ (.A1(_0313_),
    .A2(_0314_),
    .A3(_0317_),
    .B1(_0340_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0341_));
 sky130_fd_sc_hd__clkbuf_4 _0812_ (.A(_0131_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0342_));
 sky130_fd_sc_hd__or3b_1 _0813_ (.A(\duty_a[10] ),
    .B(_0315_),
    .C_N(_0129_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0343_));
 sky130_fd_sc_hd__o211ai_2 _0814_ (.A1(_0127_),
    .A2(\duty_a[11] ),
    .B1(_0342_),
    .C1(_0343_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0344_));
 sky130_fd_sc_hd__o21bai_4 _0815_ (.A1(_0341_),
    .A2(_0344_),
    .B1_N(\dt_a.prev_in ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0345_));
 sky130_fd_sc_hd__or3b_4 _0816_ (.A(_0341_),
    .B(_0344_),
    .C_N(\dt_a.prev_in ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0346_));
 sky130_fd_sc_hd__or3_1 _0817_ (.A(\dt_a.dt_cnt[2] ),
    .B(\dt_a.dt_cnt[1] ),
    .C(\dt_a.dt_cnt[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0347_));
 sky130_fd_sc_hd__or2_4 _0818_ (.A(\dt_a.dt_cnt[3] ),
    .B(_0347_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0348_));
 sky130_fd_sc_hd__or3_1 _0819_ (.A(\dt_a.dt_cnt[5] ),
    .B(\dt_a.dt_cnt[4] ),
    .C(_0348_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0349_));
 sky130_fd_sc_hd__or2_1 _0820_ (.A(\dt_a.dt_cnt[6] ),
    .B(_0349_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0350_));
 sky130_fd_sc_hd__or2_1 _0821_ (.A(\dt_a.dt_cnt[7] ),
    .B(_0350_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0351_));
 sky130_fd_sc_hd__a21oi_2 _0822_ (.A1(_0345_),
    .A2(_0346_),
    .B1(_0351_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0352_));
 sky130_fd_sc_hd__or2_1 _0823_ (.A(_0124_),
    .B(net125),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0353_));
 sky130_fd_sc_hd__nand2_4 _0824_ (.A(_0345_),
    .B(_0346_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0354_));
 sky130_fd_sc_hd__buf_6 _0825_ (.A(_0354_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0355_));
 sky130_fd_sc_hd__clkbuf_2 _0826_ (.A(_0124_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0356_));
 sky130_fd_sc_hd__a211oi_1 _0827_ (.A1(\dt_a.dt_cnt[0] ),
    .A2(_0355_),
    .B1(net126),
    .C1(_0356_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0357_));
 sky130_fd_sc_hd__or2_1 _0828_ (.A(\dt_a.dt_cfg[0] ),
    .B(_0355_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0358_));
 sky130_fd_sc_hd__a22o_1 _0829_ (.A1(net154),
    .A2(_0353_),
    .B1(_0357_),
    .B2(_0358_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0075_));
 sky130_fd_sc_hd__or2b_1 _0830_ (.A(\dt_a.dt_cnt[0] ),
    .B_N(\dt_a.dt_cnt[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0359_));
 sky130_fd_sc_hd__mux2_1 _0831_ (.A0(\dt_a.dt_cfg[1] ),
    .A1(_0359_),
    .S(_0355_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0360_));
 sky130_fd_sc_hd__o22a_1 _0832_ (.A1(net138),
    .A2(_0357_),
    .B1(_0360_),
    .B2(_0353_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0076_));
 sky130_fd_sc_hd__o21ai_1 _0833_ (.A1(\dt_a.dt_cnt[1] ),
    .A2(\dt_a.dt_cnt[0] ),
    .B1(\dt_a.dt_cnt[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0361_));
 sky130_fd_sc_hd__nand2_1 _0834_ (.A(_0347_),
    .B(_0361_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0362_));
 sky130_fd_sc_hd__mux2_2 _0835_ (.A0(\dt_a.dt_cfg[2] ),
    .A1(_0362_),
    .S(_0355_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0363_));
 sky130_fd_sc_hd__nor2_2 _0836_ (.A(_0124_),
    .B(_0352_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0364_));
 sky130_fd_sc_hd__mux2_4 _0837_ (.A0(\dt_a.dt_cnt[2] ),
    .A1(_0363_),
    .S(_0364_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0365_));
 sky130_fd_sc_hd__clkbuf_1 _0838_ (.A(_0365_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0077_));
 sky130_fd_sc_hd__nand2_1 _0839_ (.A(\dt_a.dt_cnt[3] ),
    .B(_0347_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0366_));
 sky130_fd_sc_hd__nand2_1 _0840_ (.A(_0348_),
    .B(_0366_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0367_));
 sky130_fd_sc_hd__mux2_2 _0841_ (.A0(\dt_a.dt_cfg[3] ),
    .A1(_0367_),
    .S(_0354_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0368_));
 sky130_fd_sc_hd__mux2_1 _0842_ (.A0(\dt_a.dt_cnt[3] ),
    .A1(_0368_),
    .S(_0364_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0369_));
 sky130_fd_sc_hd__clkbuf_1 _0843_ (.A(_0369_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0078_));
 sky130_fd_sc_hd__xnor2_1 _0844_ (.A(\dt_a.dt_cnt[4] ),
    .B(_0348_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0370_));
 sky130_fd_sc_hd__mux2_2 _0845_ (.A0(\dt_a.dt_cfg[4] ),
    .A1(_0370_),
    .S(_0354_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0371_));
 sky130_fd_sc_hd__mux2_1 _0846_ (.A0(\dt_a.dt_cnt[4] ),
    .A1(_0371_),
    .S(_0364_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0372_));
 sky130_fd_sc_hd__clkbuf_1 _0847_ (.A(_0372_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0079_));
 sky130_fd_sc_hd__o21ai_1 _0848_ (.A1(\dt_a.dt_cnt[4] ),
    .A2(_0348_),
    .B1(\dt_a.dt_cnt[5] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0373_));
 sky130_fd_sc_hd__nand2_1 _0849_ (.A(_0349_),
    .B(_0373_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0374_));
 sky130_fd_sc_hd__mux2_2 _0850_ (.A0(\dt_a.dt_cfg[5] ),
    .A1(_0374_),
    .S(_0354_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0375_));
 sky130_fd_sc_hd__mux2_1 _0851_ (.A0(net163),
    .A1(_0375_),
    .S(_0364_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0376_));
 sky130_fd_sc_hd__clkbuf_1 _0852_ (.A(_0376_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0080_));
 sky130_fd_sc_hd__nand2_1 _0853_ (.A(\dt_a.dt_cnt[6] ),
    .B(_0349_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0377_));
 sky130_fd_sc_hd__nand2_1 _0854_ (.A(_0350_),
    .B(_0377_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0378_));
 sky130_fd_sc_hd__mux2_2 _0855_ (.A0(\dt_a.dt_cfg[6] ),
    .A1(_0378_),
    .S(_0354_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0379_));
 sky130_fd_sc_hd__mux2_1 _0856_ (.A0(\dt_a.dt_cnt[6] ),
    .A1(_0379_),
    .S(_0364_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0380_));
 sky130_fd_sc_hd__clkbuf_1 _0857_ (.A(_0380_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0081_));
 sky130_fd_sc_hd__nor2_1 _0858_ (.A(_0125_),
    .B(_0355_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0381_));
 sky130_fd_sc_hd__a21o_1 _0859_ (.A1(_0355_),
    .A2(_0350_),
    .B1(_0356_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0382_));
 sky130_fd_sc_hd__a22o_1 _0860_ (.A1(net169),
    .A2(_0381_),
    .B1(_0382_),
    .B2(net133),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0082_));
 sky130_fd_sc_hd__and3_1 _0861_ (.A(_0342_),
    .B(_0354_),
    .C(_0351_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0383_));
 sky130_fd_sc_hd__nor2_1 _0862_ (.A(_0125_),
    .B(_0351_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0384_));
 sky130_fd_sc_hd__nor2_1 _0863_ (.A(_0341_),
    .B(_0344_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0385_));
 sky130_fd_sc_hd__nor2_1 _0864_ (.A(\dt_a.prev_in ),
    .B(_0385_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0386_));
 sky130_fd_sc_hd__a22o_1 _0865_ (.A1(net135),
    .A2(_0383_),
    .B1(_0384_),
    .B2(_0386_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0083_));
 sky130_fd_sc_hd__and2_1 _0866_ (.A(\dt_a.prev_in ),
    .B(_0385_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0387_));
 sky130_fd_sc_hd__mux2_1 _0867_ (.A0(_0387_),
    .A1(net42),
    .S(_0383_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0388_));
 sky130_fd_sc_hd__clkbuf_1 _0868_ (.A(_0388_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0084_));
 sky130_fd_sc_hd__o22a_1 _0869_ (.A1(_0133_),
    .A2(\duty_b[9] ),
    .B1(\duty_b[8] ),
    .B2(_0134_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0389_));
 sky130_fd_sc_hd__and2_1 _0870_ (.A(_0133_),
    .B(\duty_b[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0390_));
 sky130_fd_sc_hd__xor2_1 _0871_ (.A(\carrier_cnt[11] ),
    .B(\duty_b[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0391_));
 sky130_fd_sc_hd__xor2_1 _0872_ (.A(\carrier_cnt[10] ),
    .B(\duty_b[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0392_));
 sky130_fd_sc_hd__or2_4 _0873_ (.A(_0391_),
    .B(_0392_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0393_));
 sky130_fd_sc_hd__and2b_1 _0874_ (.A_N(\carrier_cnt[6] ),
    .B(net127),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0394_));
 sky130_fd_sc_hd__and2b_1 _0875_ (.A_N(\carrier_cnt[7] ),
    .B(\duty_b[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0395_));
 sky130_fd_sc_hd__and2b_1 _0876_ (.A_N(_0141_),
    .B(net114),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0396_));
 sky130_fd_sc_hd__o21bai_1 _0877_ (.A1(_0394_),
    .A2(_0395_),
    .B1_N(_0396_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0397_));
 sky130_fd_sc_hd__inv_2 _0878_ (.A(\duty_b[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0398_));
 sky130_fd_sc_hd__and2b_1 _0879_ (.A_N(\duty_b[5] ),
    .B(\carrier_cnt[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0399_));
 sky130_fd_sc_hd__a21oi_1 _0880_ (.A1(_0250_),
    .A2(_0398_),
    .B1(_0399_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0400_));
 sky130_fd_sc_hd__and2b_1 _0881_ (.A_N(_0249_),
    .B(\duty_b[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0401_));
 sky130_fd_sc_hd__and2b_1 _0882_ (.A_N(_0139_),
    .B(net113),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0402_));
 sky130_fd_sc_hd__or4_4 _0883_ (.A(_0394_),
    .B(_0395_),
    .C(_0402_),
    .D(_0396_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0403_));
 sky130_fd_sc_hd__or3_4 _0884_ (.A(_0400_),
    .B(_0401_),
    .C(_0403_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0404_));
 sky130_fd_sc_hd__or2b_1 _0885_ (.A(\duty_b[1] ),
    .B_N(\carrier_cnt[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0405_));
 sky130_fd_sc_hd__and2b_1 _0886_ (.A_N(\carrier_cnt[2] ),
    .B(\duty_b[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0406_));
 sky130_fd_sc_hd__and2b_1 _0887_ (.A_N(_0245_),
    .B(\duty_b[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0407_));
 sky130_fd_sc_hd__a311o_1 _0888_ (.A1(_0329_),
    .A2(\duty_b[0] ),
    .A3(_0405_),
    .B1(_0406_),
    .C1(_0407_),
    ...
    .VPWR(VPWR),
    .X(_0408_));
 sky130_fd_sc_hd__o22a_1 _0889_ (.A1(_0276_),
    .A2(\duty_b[3] ),
    .B1(\duty_b[2] ),
    .B2(_0158_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0409_));
 sky130_fd_sc_hd__a22o_1 _0890_ (.A1(_0145_),
    .A2(\duty_b[4] ),
    .B1(\duty_b[3] ),
    .B2(_0276_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0410_));
 sky130_fd_sc_hd__a211o_1 _0891_ (.A1(\carrier_cnt[4] ),
    .A2(_0398_),
    .B1(_0399_),
    .C1(_0401_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0411_));
 sky130_fd_sc_hd__a2111o_1 _0892_ (.A1(_0408_),
    .A2(_0409_),
    .B1(_0410_),
    .C1(_0403_),
    .D1(_0411_),
    ...
    .VPWR(VPWR),
    .X(_0412_));
 sky130_fd_sc_hd__and2_1 _0893_ (.A(_0134_),
    .B(\duty_b[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0413_));
 sky130_fd_sc_hd__or4b_1 _0894_ (.A(_0413_),
    .B(_0390_),
    .C(_0393_),
    .D_N(_0389_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0414_));
 sky130_fd_sc_hd__a31o_1 _0895_ (.A1(_0397_),
    .A2(_0404_),
    .A3(_0412_),
    .B1(_0414_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0415_));
 sky130_fd_sc_hd__o31ai_4 _0896_ (.A1(_0389_),
    .A2(_0390_),
    .A3(_0393_),
    .B1(_0415_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0416_));
 sky130_fd_sc_hd__or3b_1 _0897_ (.A(\duty_b[10] ),
    .B(_0391_),
    .C_N(_0129_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0417_));
 sky130_fd_sc_hd__o211ai_4 _0898_ (.A1(_0127_),
    .A2(net116),
    .B1(_0342_),
    .C1(_0417_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0418_));
 sky130_fd_sc_hd__o21bai_4 _0899_ (.A1(_0416_),
    .A2(_0418_),
    .B1_N(\dt_b.prev_in ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0419_));
 sky130_fd_sc_hd__or3b_4 _0900_ (.A(_0416_),
    .B(_0418_),
    .C_N(\dt_b.prev_in ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0420_));
 sky130_fd_sc_hd__or3_1 _0901_ (.A(\dt_b.dt_cnt[2] ),
    .B(\dt_b.dt_cnt[1] ),
    .C(\dt_b.dt_cnt[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0421_));
 sky130_fd_sc_hd__or2_4 _0902_ (.A(\dt_b.dt_cnt[3] ),
    .B(_0421_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0422_));
 sky130_fd_sc_hd__or3_1 _0903_ (.A(\dt_b.dt_cnt[5] ),
    .B(\dt_b.dt_cnt[4] ),
    .C(_0422_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0423_));
 sky130_fd_sc_hd__or2_1 _0904_ (.A(\dt_b.dt_cnt[6] ),
    .B(_0423_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0424_));
 sky130_fd_sc_hd__or2_1 _0905_ (.A(\dt_b.dt_cnt[7] ),
    .B(_0424_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0425_));
 sky130_fd_sc_hd__a21oi_2 _0906_ (.A1(_0419_),
    .A2(_0420_),
    .B1(_0425_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0426_));
 sky130_fd_sc_hd__or2_1 _0907_ (.A(_0124_),
    .B(_0426_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0427_));
 sky130_fd_sc_hd__nand2_4 _0908_ (.A(_0420_),
    .B(_0419_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0428_));
 sky130_fd_sc_hd__buf_6 _0909_ (.A(_0428_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0429_));
 sky130_fd_sc_hd__a211oi_1 _0910_ (.A1(\dt_b.dt_cnt[0] ),
    .A2(_0429_),
    .B1(_0426_),
    .C1(_0356_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0430_));
 sky130_fd_sc_hd__or2_1 _0911_ (.A(\dt_a.dt_cfg[0] ),
    .B(_0429_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0431_));
 sky130_fd_sc_hd__a22o_1 _0912_ (.A1(net157),
    .A2(_0427_),
    .B1(_0430_),
    .B2(_0431_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0085_));
 sky130_fd_sc_hd__or2b_1 _0913_ (.A(\dt_b.dt_cnt[0] ),
    .B_N(\dt_b.dt_cnt[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0432_));
 sky130_fd_sc_hd__mux2_1 _0914_ (.A0(\dt_a.dt_cfg[1] ),
    .A1(_0432_),
    .S(_0429_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0433_));
 sky130_fd_sc_hd__o22a_1 _0915_ (.A1(net142),
    .A2(_0430_),
    .B1(_0433_),
    .B2(_0427_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0086_));
 sky130_fd_sc_hd__o21ai_1 _0916_ (.A1(\dt_b.dt_cnt[1] ),
    .A2(\dt_b.dt_cnt[0] ),
    .B1(\dt_b.dt_cnt[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0434_));
 sky130_fd_sc_hd__nand2_1 _0917_ (.A(_0421_),
    .B(_0434_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0435_));
 sky130_fd_sc_hd__mux2_2 _0918_ (.A0(\dt_a.dt_cfg[2] ),
    .A1(_0435_),
    .S(_0429_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0436_));
 sky130_fd_sc_hd__nor2_2 _0919_ (.A(_0123_),
    .B(_0426_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0437_));
 sky130_fd_sc_hd__mux2_4 _0920_ (.A0(\dt_b.dt_cnt[2] ),
    .A1(_0436_),
    .S(_0437_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0438_));
 sky130_fd_sc_hd__clkbuf_1 _0921_ (.A(_0438_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0087_));
 sky130_fd_sc_hd__nand2_1 _0922_ (.A(\dt_b.dt_cnt[3] ),
    .B(_0421_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0439_));
 sky130_fd_sc_hd__nand2_1 _0923_ (.A(_0422_),
    .B(_0439_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0440_));
 sky130_fd_sc_hd__mux2_2 _0924_ (.A0(\dt_a.dt_cfg[3] ),
    .A1(_0440_),
    .S(_0428_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0441_));
 sky130_fd_sc_hd__mux2_1 _0925_ (.A0(\dt_b.dt_cnt[3] ),
    .A1(_0441_),
    .S(_0437_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0442_));
 sky130_fd_sc_hd__clkbuf_1 _0926_ (.A(_0442_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0088_));
 sky130_fd_sc_hd__xnor2_1 _0927_ (.A(\dt_b.dt_cnt[4] ),
    .B(_0422_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0443_));
 sky130_fd_sc_hd__mux2_2 _0928_ (.A0(\dt_a.dt_cfg[4] ),
    .A1(_0443_),
    .S(_0428_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0444_));
 sky130_fd_sc_hd__mux2_1 _0929_ (.A0(\dt_b.dt_cnt[4] ),
    .A1(_0444_),
    .S(_0437_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _0930_ (.A(_0445_),
    ...
    .VPWR(VPWR),
    .X(_0089_));
 sky130_fd_sc_hd__o21ai_1 _0931_ (.A1(\dt_b.dt_cnt[4] ),
    .A2(_0422_),
    .B1(\dt_b.dt_cnt[5] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0446_));
 sky130_fd_sc_hd__nand2_1 _0932_ (.A(_0423_),
    .B(_0446_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0447_));
 sky130_fd_sc_hd__mux2_2 _0933_ (.A0(\dt_a.dt_cfg[5] ),
    .A1(_0447_),
    .S(_0428_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0448_));
 sky130_fd_sc_hd__mux2_1 _0934_ (.A0(net167),
    .A1(_0448_),
    .S(_0437_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _0935_ (.A(_0449_),
    ...
    .VPWR(VPWR),
    .X(_0090_));
 sky130_fd_sc_hd__nand2_1 _0936_ (.A(\dt_b.dt_cnt[6] ),
    .B(_0423_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0450_));
 sky130_fd_sc_hd__nand2_1 _0937_ (.A(_0424_),
    .B(_0450_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0451_));
 sky130_fd_sc_hd__mux2_2 _0938_ (.A0(\dt_a.dt_cfg[6] ),
    .A1(_0451_),
    .S(_0428_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0452_));
 sky130_fd_sc_hd__mux2_1 _0939_ (.A0(net168),
    .A1(_0452_),
    .S(_0437_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0453_));
 sky130_fd_sc_hd__clkbuf_1 _0940_ (.A(_0453_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0091_));
 sky130_fd_sc_hd__nor2_1 _0941_ (.A(_0356_),
    .B(_0429_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0454_));
 sky130_fd_sc_hd__a21o_1 _0942_ (.A1(_0429_),
    .A2(_0424_),
    .B1(_0356_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0455_));
 sky130_fd_sc_hd__a22o_1 _0943_ (.A1(net169),
    .A2(_0454_),
    .B1(_0455_),
    .B2(net134),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0092_));
 sky130_fd_sc_hd__and3_1 _0944_ (.A(_0342_),
    .B(_0428_),
    .C(_0425_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0456_));
 sky130_fd_sc_hd__nor2_1 _0945_ (.A(_0125_),
    .B(_0425_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0457_));
 sky130_fd_sc_hd__nor2_1 _0946_ (.A(_0416_),
    .B(_0418_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0458_));
 sky130_fd_sc_hd__nor2_1 _0947_ (.A(\dt_b.prev_in ),
    .B(_0458_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0459_));
 sky130_fd_sc_hd__a22o_1 _0948_ (.A1(net136),
    .A2(_0456_),
    .B1(_0457_),
    .B2(_0459_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0093_));
 sky130_fd_sc_hd__and2_1 _0949_ (.A(\dt_b.prev_in ),
    .B(_0458_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0460_));
 sky130_fd_sc_hd__mux2_1 _0950_ (.A0(_0460_),
    .A1(net44),
    .S(_0456_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0461_));
 sky130_fd_sc_hd__clkbuf_1 _0951_ (.A(_0461_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0094_));
 sky130_fd_sc_hd__a21o_1 _0952_ (.A1(net151),
    .A2(_0125_),
    .B1(_0385_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0095_));
 sky130_fd_sc_hd__a21oi_2 _0953_ (.A1(_0167_),
    .A2(_0132_),
    .B1(\dt_c.prev_in ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0462_));
 sky130_fd_sc_hd__and3_1 _0954_ (.A(\dt_c.prev_in ),
    .B(_0167_),
    .C(_0132_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0463_));
 sky130_fd_sc_hd__or3_1 _0955_ (.A(\dt_c.dt_cnt[2] ),
    .B(\dt_c.dt_cnt[1] ),
    .C(\dt_c.dt_cnt[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0464_));
 sky130_fd_sc_hd__or2_2 _0956_ (.A(\dt_c.dt_cnt[3] ),
    .B(_0464_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0465_));
 sky130_fd_sc_hd__or3_1 _0957_ (.A(\dt_c.dt_cnt[5] ),
    .B(\dt_c.dt_cnt[4] ),
    .C(_0465_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0466_));
 sky130_fd_sc_hd__or2_2 _0958_ (.A(\dt_c.dt_cnt[6] ),
    .B(_0466_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0467_));
 sky130_fd_sc_hd__o21ai_4 _0959_ (.A1(\dt_c.dt_cnt[7] ),
    .A2(_0467_),
    .B1(_0342_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0468_));
 sky130_fd_sc_hd__o31a_1 _0960_ (.A1(_0123_),
    .A2(_0462_),
    .A3(net118),
    .B1(_0468_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0469_));
 sky130_fd_sc_hd__or2_4 _0961_ (.A(_0462_),
    .B(_0463_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0470_));
 sky130_fd_sc_hd__clkbuf_2 _0962_ (.A(_0470_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0471_));
 sky130_fd_sc_hd__a21oi_1 _0963_ (.A1(\dt_c.dt_cnt[0] ),
    .A2(_0471_),
    .B1(_0469_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0472_));
 sky130_fd_sc_hd__or2_1 _0964_ (.A(\dt_a.dt_cfg[0] ),
    .B(_0471_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0473_));
 sky130_fd_sc_hd__a22o_1 _0965_ (.A1(net158),
    .A2(_0469_),
    .B1(_0472_),
    .B2(_0473_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0096_));
 sky130_fd_sc_hd__or2b_1 _0966_ (.A(\dt_c.dt_cnt[0] ),
    .B_N(\dt_c.dt_cnt[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0474_));
 sky130_fd_sc_hd__buf_8 _0967_ (.A(_0470_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0475_));
 sky130_fd_sc_hd__mux2_1 _0968_ (.A0(\dt_a.dt_cfg[1] ),
    .A1(_0474_),
    .S(_0475_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0476_));
 sky130_fd_sc_hd__o22a_1 _0969_ (.A1(net147),
    .A2(_0472_),
    .B1(_0476_),
    .B2(_0469_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0097_));
 sky130_fd_sc_hd__o21ai_1 _0970_ (.A1(\dt_c.dt_cnt[1] ),
    .A2(\dt_c.dt_cnt[0] ),
    .B1(\dt_c.dt_cnt[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0477_));
 sky130_fd_sc_hd__nand2_1 _0971_ (.A(_0464_),
    .B(_0477_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0478_));
 sky130_fd_sc_hd__mux2_4 _0972_ (.A0(\dt_a.dt_cfg[2] ),
    .A1(_0478_),
    .S(_0475_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0479_));
 sky130_fd_sc_hd__o21ai_4 _0973_ (.A1(_0123_),
    .A2(_0475_),
    .B1(_0468_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0480_));
 sky130_fd_sc_hd__mux2_1 _0974_ (.A0(\dt_c.dt_cnt[2] ),
    .A1(_0479_),
    .S(_0480_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0481_));
 sky130_fd_sc_hd__clkbuf_1 _0975_ (.A(_0481_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0098_));
 sky130_fd_sc_hd__nand2_1 _0976_ (.A(\dt_c.dt_cnt[3] ),
    .B(_0464_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0482_));
 sky130_fd_sc_hd__nand2_1 _0977_ (.A(_0465_),
    .B(_0482_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0483_));
 sky130_fd_sc_hd__mux2_1 _0978_ (.A0(\dt_a.dt_cfg[3] ),
    .A1(_0483_),
    .S(_0475_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0484_));
 sky130_fd_sc_hd__mux2_4 _0979_ (.A0(\dt_c.dt_cnt[3] ),
    .A1(_0484_),
    .S(_0480_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _0980_ (.A(_0485_),
    ...
    .VPWR(VPWR),
    .X(_0099_));
 sky130_fd_sc_hd__xnor2_1 _0981_ (.A(\dt_c.dt_cnt[4] ),
    .B(_0465_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0486_));
 sky130_fd_sc_hd__mux2_1 _0982_ (.A0(\dt_a.dt_cfg[4] ),
    .A1(_0486_),
    .S(_0475_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0487_));
 sky130_fd_sc_hd__mux2_4 _0983_ (.A0(\dt_c.dt_cnt[4] ),
    .A1(_0487_),
    .S(_0480_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _0984_ (.A(_0488_),
    ...
    .VPWR(VPWR),
    .X(_0100_));
 sky130_fd_sc_hd__o21ai_1 _0985_ (.A1(\dt_c.dt_cnt[4] ),
    .A2(_0465_),
    .B1(\dt_c.dt_cnt[5] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0489_));
 sky130_fd_sc_hd__nand2_1 _0986_ (.A(_0466_),
    .B(_0489_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0490_));
 sky130_fd_sc_hd__mux2_1 _0987_ (.A0(\dt_a.dt_cfg[5] ),
    .A1(_0490_),
    .S(_0475_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0491_));
 sky130_fd_sc_hd__mux2_4 _0988_ (.A0(\dt_c.dt_cnt[5] ),
    .A1(_0491_),
    .S(_0480_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0492_));
 sky130_fd_sc_hd__clkbuf_1 _0989_ (.A(_0492_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0101_));
 sky130_fd_sc_hd__nand2_1 _0990_ (.A(\dt_c.dt_cnt[6] ),
    .B(_0466_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0493_));
 sky130_fd_sc_hd__nand2_1 _0991_ (.A(_0467_),
    .B(_0493_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0494_));
 sky130_fd_sc_hd__mux2_1 _0992_ (.A0(\dt_a.dt_cfg[6] ),
    .A1(_0494_),
    .S(_0470_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0495_));
 sky130_fd_sc_hd__mux2_1 _0993_ (.A0(\dt_c.dt_cnt[6] ),
    .A1(_0495_),
    .S(_0480_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _0994_ (.A(_0496_),
    ...
    .VPWR(VPWR),
    .X(_0102_));
 sky130_fd_sc_hd__nor2_1 _0995_ (.A(_0356_),
    .B(_0471_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0497_));
 sky130_fd_sc_hd__a21o_1 _0996_ (.A1(_0471_),
    .A2(_0467_),
    .B1(_0124_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0498_));
 sky130_fd_sc_hd__a22o_1 _0997_ (.A1(net169),
    .A2(_0497_),
    .B1(_0498_),
    .B2(net152),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0103_));
 sky130_fd_sc_hd__inv_2 _0998_ (.A(_0468_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0499_));
 sky130_fd_sc_hd__and3_1 _0999_ (.A(_0342_),
    .B(_0462_),
    .C(_0468_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0500_));
 sky130_fd_sc_hd__a31o_1 _1000_ (.A1(net145),
    .A2(_0471_),
    .A3(_0499_),
    .B1(_0500_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0104_));
 sky130_fd_sc_hd__and3_1 _1001_ (.A(net46),
    .B(_0471_),
    .C(_0499_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0501_));
 sky130_fd_sc_hd__a21o_1 _1002_ (.A1(net119),
    .A2(_0468_),
    .B1(_0501_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0105_));
 sky130_fd_sc_hd__a21o_1 _1003_ (.A1(net146),
    .A2(_0125_),
    .B1(_0458_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _1004_ (.CLK(clknet_3_0__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(net41));
 sky130_fd_sc_hd__dfrtp_1 _1005_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0002_),
    .RESET_B(net67),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _1007_ (.CLK(clknet_3_1__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(net37));
 sky130_fd_sc_hd__dfrtp_1 _1008_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0005_),
    .RESET_B(net64),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net40));
 sky130_fd_sc_hd__dfrtp_1 _1009_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0006_),
    .RESET_B(net50),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _1010_ (.CLK(clknet_3_1__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(net39));
 sky130_fd_sc_hd__dfrtp_1 _1011_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0000_),
    .RESET_B(net48),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(fault_clear));
 sky130_fd_sc_hd__dfrtp_1 _1012_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0008_),
    .RESET_B(net48),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(pwm_enable));
 sky130_fd_sc_hd__dfrtp_1 _1013_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0009_),
    .RESET_B(net56),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\duty_a[0] ));
 sky130_fd_sc_hd__dfrtp_1 _1014_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0010_),
    .RESET_B(net50),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\duty_a[1] ));
 sky130_fd_sc_hd__dfstp_1 _1015_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0011_),
    .SET_B(net56),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\duty_a[2] ));
 sky130_fd_sc_hd__dfrtp_1 _1016_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0012_),
    .RESET_B(net57),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\duty_a[3] ));
 sky130_fd_sc_hd__dfrtp_1 _1017_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0013_),
    .RESET_B(net57),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\duty_a[4] ));
 sky130_fd_sc_hd__dfrtp_1 _1018_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0014_),
    .RESET_B(net57),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\duty_a[5] ));
 sky130_fd_sc_hd__dfstp_1 _1019_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0015_),
    .SET_B(net57),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\duty_a[6] ));
 sky130_fd_sc_hd__dfstp_1 _1020_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0016_),
    .SET_B(net67),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfstp_1 _1021_ (.CLK(clknet_3_4__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\duty_a[8] ));
 sky130_fd_sc_hd__dfrtp_1 _1022_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0018_),
    .RESET_B(net63),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\duty_a[9] ));
 sky130_fd_sc_hd__dfrtp_1 _1023_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0019_),
    .RESET_B(net63),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\duty_a[10] ));
 sky130_fd_sc_hd__dfstp_1 _1024_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0020_),
    .SET_B(net63),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\duty_a[11] ));
 sky130_fd_sc_hd__dfrtp_1 _1025_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0021_),
    .RESET_B(net50),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\duty_b[0] ));
 sky130_fd_sc_hd__dfrtp_1 _1026_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0022_),
    .RESET_B(net50),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\duty_b[1] ));
 sky130_fd_sc_hd__dfstp_1 _1027_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0023_),
    .SET_B(net51),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\duty_b[2] ));
 sky130_fd_sc_hd__dfrtp_1 _1028_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0024_),
    .RESET_B(net57),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\duty_b[3] ));
 sky130_fd_sc_hd__dfrtp_1 _1029_ (.CLK(clknet_3_1__leaf_clk),
    .D(_0025_),
    .RESET_B(net53),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _1030_ (.CLK(clknet_3_1__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\duty_b[5] ));
 sky130_fd_sc_hd__dfstp_1 _1031_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0027_),
    .SET_B(net58),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\duty_b[6] ));
 sky130_fd_sc_hd__dfstp_1 _1032_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0028_),
    .SET_B(net67),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\duty_b[7] ));
 sky130_fd_sc_hd__dfstp_1 _1033_ (.CLK(clknet_3_4__leaf_clk),
    .D(_0029_),
    .SET_B(net63),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\duty_b[8] ));
 sky130_fd_sc_hd__dfrtp_1 _1034_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0030_),
    .RESET_B(net63),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _1035_ (.CLK(clknet_3_5__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\duty_b[10] ));
 sky130_fd_sc_hd__dfstp_1 _1036_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0032_),
    .SET_B(net64),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\duty_b[11] ));
 sky130_fd_sc_hd__dfrtp_1 _1037_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0033_),
    .RESET_B(net48),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _1040_ (.CLK(clknet_3_0__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\duty_c[3] ));
 sky130_fd_sc_hd__dfrtp_1 _1041_ (.CLK(clknet_3_1__leaf_clk),
    .D(_0037_),
    .RESET_B(net51),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\duty_c[4] ));
 sky130_fd_sc_hd__dfrtp_1 _1042_ (.CLK(clknet_3_1__leaf_clk),
    .D(_0038_),
    .RESET_B(net51),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\duty_c[5] ));
 sky130_fd_sc_hd__dfstp_1 _1043_ (.CLK(clknet_3_4__leaf_clk),
    .D(_0039_),
    .SET_B(net61),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\duty_c[6] ));
 sky130_fd_sc_hd__dfstp_1 _1044_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0040_),
    .SET_B(net62),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\duty_c[7] ));
 sky130_fd_sc_hd__dfstp_1 _1045_ (.CLK(clknet_3_4__leaf_clk),
    .D(_0041_),
    .SET_B(net62),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\duty_c[8] ));
 sky130_fd_sc_hd__dfrtp_1 _1046_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0042_),
    .RESET_B(net65),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\duty_c[9] ));
 sky130_fd_sc_hd__dfrtp_1 _1047_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0043_),
    .RESET_B(net64),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\duty_c[10] ));
 sky130_fd_sc_hd__dfstp_1 _1048_ (.CLK(clknet_3_4__leaf_clk),
    .D(_0044_),
    .SET_B(net61),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\duty_c[11] ));
 sky130_fd_sc_hd__dfrtp_1 _1049_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0045_),
    .RESET_B(net55),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\dt_a.dt_cfg[0] ));
 sky130_fd_sc_hd__dfrtp_1 _1050_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0046_),
    .RESET_B(net55),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\dt_a.dt_cfg[1] ));
 sky130_fd_sc_hd__dfrtp_1 _1051_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0047_),
    .RESET_B(net55),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\dt_a.dt_cfg[2] ));
 sky130_fd_sc_hd__dfstp_1 _1052_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0048_),
    .SET_B(net56),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\dt_a.dt_cfg[3] ));
 sky130_fd_sc_hd__dfrtp_2 _1053_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0049_),
    .RESET_B(net56),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\dt_a.dt_cfg[4] ));
 sky130_fd_sc_hd__dfstp_1 _1054_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0050_),
    .SET_B(net56),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\dt_a.dt_cfg[5] ));
 sky130_fd_sc_hd__dfrtp_1 _1055_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0051_),
    .RESET_B(net58),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\dt_a.dt_cfg[6] ));
 sky130_fd_sc_hd__dfrtp_1 _1056_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0052_),
    .RESET_B(net58),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\dt_a.dt_cfg[7] ));
 sky130_fd_sc_hd__dfxtp_1 _1057_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0053_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\aw_addr_reg[0] ));
 sky130_fd_sc_hd__dfxtp_1 _1058_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0054_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\aw_addr_reg[1] ));
 sky130_fd_sc_hd__dfxtp_1 _1059_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\aw_addr_reg[2] ));
 sky130_fd_sc_hd__dfxtp_1 _1060_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0056_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_1 _1062_ (.CLK(clknet_3_2__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\aw_addr_reg[5] ));
 sky130_fd_sc_hd__dfxtp_1 _1063_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0059_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_1 _1064_ (.CLK(clknet_3_2__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\aw_addr_reg[7] ));
 sky130_fd_sc_hd__dfrtp_1 _1065_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0061_),
    .RESET_B(net55),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(aw_active));
 sky130_fd_sc_hd__dfrtp_1 _1066_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0062_),
    .RESET_B(net49),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\carrier_cnt[0] ));
 sky130_fd_sc_hd__dfrtp_1 _1067_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0063_),
    .RESET_B(net48),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\carrier_cnt[1] ));
 sky130_fd_sc_hd__dfrtp_4 _1068_ (.CLK(clknet_3_1__leaf_clk),
    .D(_0064_),
    .RESET_B(net49),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\carrier_cnt[2] ));
 sky130_fd_sc_hd__dfrtp_2 _1069_ (.CLK(clknet_3_1__leaf_clk),
    .D(_0065_),
    .RESET_B(net53),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\carrier_cnt[3] ));
 sky130_fd_sc_hd__dfrtp_1 _1070_ (.CLK(clknet_3_1__leaf_clk),
    .D(_0066_),
    .RESET_B(net53),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\carrier_cnt[4] ));
 sky130_fd_sc_hd__dfrtp_1 _1071_ (.CLK(clknet_3_1__leaf_clk),
    .D(_0067_),
    .RESET_B(net54),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\carrier_cnt[5] ));
 sky130_fd_sc_hd__dfrtp_1 _1072_ (.CLK(clknet_3_1__leaf_clk),
    .D(_0068_),
    .RESET_B(net54),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\carrier_cnt[6] ));
 sky130_fd_sc_hd__dfrtp_1 _1073_ (.CLK(clknet_3_4__leaf_clk),
    .D(_0069_),
    .RESET_B(net62),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\carrier_cnt[7] ));
 sky130_fd_sc_hd__dfrtp_2 _1074_ (.CLK(clknet_3_4__leaf_clk),
    .D(_0070_),
    .RESET_B(net61),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\carrier_cnt[8] ));
 sky130_fd_sc_hd__dfrtp_1 _1075_ (.CLK(clknet_3_4__leaf_clk),
    .D(_0071_),
    .RESET_B(net61),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\carrier_cnt[9] ));
 sky130_fd_sc_hd__dfrtp_2 _1076_ (.CLK(clknet_3_4__leaf_clk),
    .D(_0072_),
    .RESET_B(net61),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\carrier_cnt[10] ));
 sky130_fd_sc_hd__dfrtp_1 _1077_ (.CLK(clknet_3_4__leaf_clk),
    .D(_0073_),
    .RESET_B(net61),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\carrier_cnt[11] ));
 sky130_fd_sc_hd__dfstp_1 _1078_ (.CLK(clknet_3_1__leaf_clk),
    .D(_0074_),
    .SET_B(net53),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(carrier_up));
 sky130_fd_sc_hd__dfrtp_1 _1079_ (.CLK(clknet_3_0__leaf_clk),
    .D(net129),
    .RESET_B(net49),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(fault_in_sync));
 sky130_fd_sc_hd__dfrtp_1 _1080_ (.CLK(clknet_3_0__leaf_clk),
    .D(net34),
    .RESET_B(net48),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(fault_in_meta));
 sky130_fd_sc_hd__dfrtp_1 _1081_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0075_),
    .RESET_B(net66),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\dt_a.dt_cnt[0] ));
 sky130_fd_sc_hd__dfrtp_1 _1082_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0076_),
    .RESET_B(net71),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\dt_a.dt_cnt[1] ));
 sky130_fd_sc_hd__dfrtp_1 _1083_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0077_),
    .RESET_B(net66),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\dt_a.dt_cnt[2] ));
 sky130_fd_sc_hd__dfrtp_1 _1084_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0078_),
    .RESET_B(net66),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\dt_a.dt_cnt[3] ));
 sky130_fd_sc_hd__dfrtp_1 _1085_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0079_),
    .RESET_B(net67),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\dt_a.dt_cnt[4] ));
 sky130_fd_sc_hd__dfrtp_1 _1086_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0080_),
    .RESET_B(net67),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _1087_ (.CLK(clknet_3_7__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\dt_a.dt_cnt[6] ));
 sky130_fd_sc_hd__dfrtp_1 _1088_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0082_),
    .RESET_B(net69),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\dt_a.dt_cnt[7] ));
 sky130_fd_sc_hd__dfrtp_1 _1089_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0083_),
    .RESET_B(net68),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net43));
 sky130_fd_sc_hd__dfrtp_2 _1090_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0084_),
    .RESET_B(net64),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net42));
 sky130_fd_sc_hd__dfrtp_1 _1091_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0085_),
    .RESET_B(net69),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\dt_b.dt_cnt[0] ));
 sky130_fd_sc_hd__dfrtp_1 _1092_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0086_),
    .RESET_B(net69),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\dt_b.dt_cnt[1] ));
 sky130_fd_sc_hd__dfrtp_1 _1093_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0087_),
    .RESET_B(net69),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\dt_b.dt_cnt[2] ));
 sky130_fd_sc_hd__dfrtp_1 _1094_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0088_),
    .RESET_B(net69),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\dt_b.dt_cnt[3] ));
 sky130_fd_sc_hd__dfrtp_1 _1095_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0089_),
    .RESET_B(net70),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\dt_b.dt_cnt[4] ));
 sky130_fd_sc_hd__dfrtp_1 _1096_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0090_),
    .RESET_B(net68),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\dt_b.dt_cnt[5] ));
 sky130_fd_sc_hd__dfrtp_1 _1097_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0091_),
    .RESET_B(net68),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\dt_b.dt_cnt[6] ));
 sky130_fd_sc_hd__dfrtp_1 _1098_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0092_),
    .RESET_B(net69),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\dt_b.dt_cnt[7] ));
 sky130_fd_sc_hd__dfrtp_1 _1099_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0093_),
    .RESET_B(net68),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net45));
 sky130_fd_sc_hd__dfrtp_1 _1100_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0094_),
    .RESET_B(net68),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net44));
 sky130_fd_sc_hd__dfrtp_1 _1101_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0095_),
    .RESET_B(net68),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\dt_a.prev_in ));
 sky130_fd_sc_hd__dfrtp_1 _1102_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0096_),
    .RESET_B(net59),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _1105_ (.CLK(clknet_3_3__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\dt_c.dt_cnt[3] ));
 sky130_fd_sc_hd__dfrtp_1 _1106_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0100_),
    .RESET_B(net60),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _1108_ (.CLK(clknet_3_3__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\dt_c.dt_cnt[6] ));
 sky130_fd_sc_hd__dfrtp_1 _1109_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0103_),
    .RESET_B(net66),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\dt_c.dt_cnt[7] ));
 sky130_fd_sc_hd__dfrtp_1 _1110_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0104_),
    .RESET_B(net66),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net47));
 sky130_fd_sc_hd__dfrtp_1 _1111_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0105_),
    .RESET_B(net66),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net46));
 sky130_fd_sc_hd__dfrtp_1 _1112_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0106_),
    .RESET_B(net70),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__buf_1 fanout51 (.A(net52),
    ...
    .VPWR(VPWR),
    .X(net51));
 sky130_fd_sc_hd__dlymetal6s2s_1 fanout52 (.A(net54),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout53 (.A(net54),
    ...
    .VPWR(VPWR),
    .X(net53));
 sky130_fd_sc_hd__clkbuf_2 fanout54 (.A(net72),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout59 (.A(net60),
    ...
    .VPWR(VPWR),
    .X(net59));
 sky130_fd_sc_hd__clkbuf_2 fanout60 (.A(net72),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout64 (.A(net65),
    ...
    .VPWR(VPWR),
    .X(net64));
 sky130_fd_sc_hd__dlymetal6s2s_1 fanout65 (.A(net72),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net65));
 sky130_fd_sc_hd__buf_2 fanout66 (.A(net71),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlymetal6s2s_1 fanout71 (.A(net72),
    ...
    .VPWR(VPWR),
    .X(net71));
 sky130_fd_sc_hd__clkbuf_2 fanout72 (.A(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net72));
 sky130_fd_sc_hd__dlygate4sd3_1 hold17 (.A(fault_in_meta),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net129));
 sky130_fd_sc_hd__dlygate4sd3_1 hold18 (.A(fault_in_sync),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold20 (.A(rst_n),
    ...
    .VPWR(VPWR),
    .X(net132));
 sky130_fd_sc_hd__dlygate4sd3_1 hold21 (.A(\dt_a.dt_cnt[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net133));
 sky130_fd_sc_hd__dlygate4sd3_1 hold22 (.A(\dt_b.dt_cnt[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold24 (.A(net45),
    ...
    .VPWR(VPWR),
    .X(net136));
 sky130_fd_sc_hd__dlygate4sd3_1 hold25 (.A(\aw_addr_reg[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net137));
 sky130_fd_sc_hd__dlygate4sd3_1 hold26 (.A(\dt_a.dt_cnt[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net138));
 sky130_fd_sc_hd__dlygate4sd3_1 hold27 (.A(\aw_addr_reg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net139));
 sky130_fd_sc_hd__dlygate4sd3_1 hold28 (.A(\aw_addr_reg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net140));
 sky130_fd_sc_hd__dlygate4sd3_1 hold29 (.A(\dt_c.prev_in ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net141));
 sky130_fd_sc_hd__dlygate4sd3_1 hold30 (.A(\dt_b.dt_cnt[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net142));
 sky130_fd_sc_hd__dlygate4sd3_1 hold31 (.A(\aw_addr_reg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net143));
 sky130_fd_sc_hd__dlygate4sd3_1 hold32 (.A(\aw_addr_reg[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net144));
 sky130_fd_sc_hd__dlygate4sd3_1 hold33 (.A(net47),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net145));
 sky130_fd_sc_hd__dlygate4sd3_1 hold34 (.A(\dt_b.prev_in ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net146));
 sky130_fd_sc_hd__dlygate4sd3_1 hold35 (.A(\dt_c.dt_cnt[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net147));
 sky130_fd_sc_hd__dlygate4sd3_1 hold36 (.A(\aw_addr_reg[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net148));
 sky130_fd_sc_hd__dlygate4sd3_1 hold37 (.A(\aw_addr_reg[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net149));
 sky130_fd_sc_hd__dlygate4sd3_1 hold38 (.A(\aw_addr_reg[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net150));
 sky130_fd_sc_hd__dlygate4sd3_1 hold39 (.A(\dt_a.prev_in ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net151));
 sky130_fd_sc_hd__dlygate4sd3_1 hold40 (.A(\dt_c.dt_cnt[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net152));
 sky130_fd_sc_hd__dlygate4sd3_1 hold41 (.A(net36),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net153));
 sky130_fd_sc_hd__dlygate4sd3_1 hold42 (.A(\dt_a.dt_cnt[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net154));
 sky130_fd_sc_hd__dlygate4sd3_1 hold43 (.A(net41),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net155));
 sky130_fd_sc_hd__dlygate4sd3_1 hold44 (.A(_0007_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net156));
 sky130_fd_sc_hd__dlygate4sd3_1 hold45 (.A(\dt_b.dt_cnt[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net157));
 sky130_fd_sc_hd__dlygate4sd3_1 hold46 (.A(\dt_c.dt_cnt[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net158));
 sky130_fd_sc_hd__dlygate4sd3_1 hold47 (.A(\duty_a[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net159));
 sky130_fd_sc_hd__dlygate4sd3_1 hold48 (.A(\duty_b[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net160));
 sky130_fd_sc_hd__dlygate4sd3_1 hold49 (.A(net38),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net161));
 sky130_fd_sc_hd__dlygate4sd3_1 hold50 (.A(\duty_c[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net162));
 sky130_fd_sc_hd__dlygate4sd3_1 hold51 (.A(\dt_a.dt_cnt[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net163));
 sky130_fd_sc_hd__dlygate4sd3_1 hold52 (.A(\duty_b[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net164));
 sky130_fd_sc_hd__dlygate4sd3_1 hold53 (.A(\duty_b[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net165));
 sky130_fd_sc_hd__dlygate4sd3_1 hold54 (.A(\duty_c[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net166));
 sky130_fd_sc_hd__dlygate4sd3_1 hold55 (.A(\dt_b.dt_cnt[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net167));
 sky130_fd_sc_hd__dlygate4sd3_1 hold56 (.A(\dt_b.dt_cnt[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net168));
 sky130_fd_sc_hd__buf_1 hold57 (.A(\dt_a.dt_cfg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net169));
 sky130_fd_sc_hd__dlygate4sd3_1 hold58 (.A(\dt_a.dt_cfg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net170));
 sky130_fd_sc_hd__buf_1 input1 (.A(axi_araddr[0]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net1));
 sky130_fd_sc_hd__clkbuf_1 input10 (.A(axi_awaddr[0]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net10));
 sky130_fd_sc_hd__buf_1 input11 (.A(axi_awaddr[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net11));
 sky130_fd_sc_hd__clkbuf_1 input12 (.A(axi_awaddr[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net12));
 sky130_fd_sc_hd__dlymetal6s2s_1 input13 (.A(axi_awaddr[3]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net13));
 sky130_fd_sc_hd__buf_1 input14 (.A(axi_awaddr[4]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net14));
 sky130_fd_sc_hd__clkbuf_1 input15 (.A(axi_awaddr[5]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net15));
 sky130_fd_sc_hd__clkbuf_2 input16 (.A(axi_awaddr[6]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net16));
 sky130_fd_sc_hd__buf_1 input17 (.A(axi_awaddr[7]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net17));
 sky130_fd_sc_hd__clkbuf_2 input18 (.A(axi_awvalid),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net18));
 sky130_fd_sc_hd__clkbuf_1 input19 (.A(axi_bready),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__buf_1 input2 (.A(axi_araddr[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net2));
 sky130_fd_sc_hd__clkbuf_1 input20 (.A(axi_rready),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net20));
 sky130_fd_sc_hd__clkbuf_2 input21 (.A(axi_wdata[0]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net21));
 sky130_fd_sc_hd__buf_1 input22 (.A(axi_wdata[10]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__clkbuf_2 input23 (.A(axi_wdata[11]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net23));
 sky130_fd_sc_hd__clkbuf_2 input24 (.A(axi_wdata[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__clkbuf_2 input25 (.A(axi_wdata[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net25));
 sky130_fd_sc_hd__clkbuf_2 input26 (.A(axi_wdata[3]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net26));
 sky130_fd_sc_hd__clkbuf_2 input27 (.A(axi_wdata[4]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net27));
 sky130_fd_sc_hd__clkbuf_2 input28 (.A(axi_wdata[5]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net28));
 sky130_fd_sc_hd__clkbuf_2 input29 (.A(axi_wdata[6]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net29));
 sky130_fd_sc_hd__clkbuf_1 input3 (.A(axi_araddr[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net3));
 sky130_fd_sc_hd__clkbuf_2 input30 (.A(axi_wdata[7]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net30));
 sky130_fd_sc_hd__buf_1 input31 (.A(axi_wdata[8]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net31));
 sky130_fd_sc_hd__buf_1 input32 (.A(axi_wdata[9]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net32));
 sky130_fd_sc_hd__buf_1 input33 (.A(axi_wvalid),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net33));
 sky130_fd_sc_hd__clkbuf_1 input34 (.A(fault_in),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net34));
 sky130_fd_sc_hd__clkbuf_1 input35 (.A(net132),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net35));
 sky130_fd_sc_hd__buf_1 input4 (.A(axi_araddr[3]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net4));
 sky130_fd_sc_hd__buf_1 input5 (.A(axi_araddr[4]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net5));
 sky130_fd_sc_hd__buf_1 input6 (.A(axi_araddr[5]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net6));
 sky130_fd_sc_hd__buf_1 input7 (.A(axi_araddr[6]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net7));
 sky130_fd_sc_hd__buf_1 input8 (.A(axi_araddr[7]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net8));
 sky130_fd_sc_hd__buf_2 input9 (.A(axi_arvalid),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 output47 (.A(net47),
    ...
    .VPWR(VPWR),
    .X(pwm_cl));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_100 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net100));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_101 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net101));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_102 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net102));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_103 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net103));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_104 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net104));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_105 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net105));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_106 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net106));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_107 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net107));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_108 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net108));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_109 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net109));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_110 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net110));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_111 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net111));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_112 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net112));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_73 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net73));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_74 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net74));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_75 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net75));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_76 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net76));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_77 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net77));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_78 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net78));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_79 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net79));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_80 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net80));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_81 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net81));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_82 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net82));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_83 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net83));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_84 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net84));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_85 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net85));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_86 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net86));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_87 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net87));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_88 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net88));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_89 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net89));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_90 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net90));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_91 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net91));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_92 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net92));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_93 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net93));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_94 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net94));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_95 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net95));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_96 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net96));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_97 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net97));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_98 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net98));
 sky130_fd_sc_hd__conb_1 pwm_3phase_controller_99 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net99));
 sky130_fd_sc_hd__clkbuf_1 rebuffer1 (.A(\duty_b[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net113));
 sky130_fd_sc_hd__buf_1 rebuffer10 (.A(net121),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net122));
 sky130_fd_sc_hd__clkbuf_1 rebuffer11 (.A(net122),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net123));
 sky130_fd_sc_hd__clkbuf_1 rebuffer12 (.A(_0150_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net124));
 sky130_fd_sc_hd__clkbuf_1 rebuffer13 (.A(_0352_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net125));
 sky130_fd_sc_hd__clkbuf_1 rebuffer14 (.A(net125),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net126));
 sky130_fd_sc_hd__clkbuf_1 rebuffer15 (.A(\duty_b[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net127));
 sky130_fd_sc_hd__clkbuf_1 rebuffer2 (.A(\duty_b[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net114));
 sky130_fd_sc_hd__clkbuf_1 rebuffer3 (.A(\duty_a[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net115));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer4 (.A(\duty_b[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net116));
 sky130_fd_sc_hd__clkbuf_1 rebuffer5 (.A(net116),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net117));
 sky130_fd_sc_hd__clkbuf_1 rebuffer6 (.A(_0463_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net118));
 sky130_fd_sc_hd__clkbuf_1 rebuffer7 (.A(net118),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net119));
 sky130_fd_sc_hd__buf_6 rebuffer8 (.A(_0139_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net120));
 sky130_fd_sc_hd__clkbuf_1 rebuffer9 (.A(net120),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net121));
 assign axi_arready = net110;
 assign axi_bresp[0] = net73;
 assign axi_bresp[1] = net74;
 assign axi_rdata[10] = net83;
 assign axi_rdata[11] = net84;
 assign axi_rdata[12] = net85;
 assign axi_rdata[13] = net86;
 assign axi_rdata[14] = net87;
 assign axi_rdata[15] = net88;
 assign axi_rdata[16] = net89;
 assign axi_rdata[17] = net90;
 assign axi_rdata[18] = net91;
 assign axi_rdata[19] = net92;
 assign axi_rdata[20] = net93;
 assign axi_rdata[21] = net94;
 assign axi_rdata[22] = net95;
 assign axi_rdata[23] = net96;
 assign axi_rdata[24] = net97;
 assign axi_rdata[25] = net98;
 assign axi_rdata[26] = net99;
 assign axi_rdata[27] = net100;
 assign axi_rdata[28] = net101;
 assign axi_rdata[29] = net102;
 assign axi_rdata[2] = net75;
 assign axi_rdata[30] = net103;
 assign axi_rdata[31] = net104;
 assign axi_rdata[3] = net76;
 assign axi_rdata[4] = net77;
 assign axi_rdata[5] = net78;
 assign axi_rdata[6] = net79;
 assign axi_rdata[7] = net80;
 assign axi_rdata[8] = net81;
 assign axi_rdata[9] = net82;
 assign axi_rresp[0] = net105;
 assign axi_rresp[1] = net106;
 assign axi_wready = net111;
 assign pwm_sync = net107;
 assign sector[0] = net112;
 assign sector[1] = net108;
 assign sector[2] = net109;
endmodule
